  ...
  Widget _getAttributeIcon() {
    switch (attribute) {
      case AttributeEnum.status:
        return Assets.svg.icStatus.svg(width: AppSize.s16);
      case AttributeEnum.agencyPhone:
        return Assets.svg.icLaptopAgency.svg(width: AppSize.s16);
      case AttributeEnum.agencyLaptop:
        return Assets.svg.icLaptopAgency.svg(width: AppSize.s16);
      case AttributeEnum.microProcessor:
        return Assets.svg.icMicroprocessor.svg(width: AppSize.s16);
      case AttributeEnum.ram:
        return Assets.svg.icRam.svg(width: AppSize.s16);
      case AttributeEnum.hardWare:
        return Assets.svg.icHardware.svg(width: AppSize.s16);
      case AttributeEnum.hardWareType:
        return Assets.svg.icHardwareType.svg(width: AppSize.s16);
      case AttributeEnum.graphicsCard:
        return Assets.svg.icGraphicsCard.svg(width: AppSize.s16);
      case AttributeEnum.screenSize:
        return Assets.svg.icScreenSize.svg(width: AppSize.s16);
      case AttributeEnum.warrantyPolicy:
        return Assets.svg.icWarranty.svg(width: AppSize.s16);
      case AttributeEnum.origin:
        return Assets.svg.icOrigin.svg(width: AppSize.s16);
      case AttributeEnum.color:
        return Assets.svg.icColor.svg(width: AppSize.s16);
      default:
